<?php
	...
	if(isset($_GET["key"])){
		...
		$read_profile = mysql_query("SELECT users.user_id as id, users.user_fname as fname, users.user_lname as lname, profile_pictures.img, profile_pictures.picture_id as img_id FROM users LEFT JOIN profile_pictures ON users.user_id = profile_pictures.user WHERE user_key = '$user_key' AND date_deleted IS NULL");
					...
					<li>
						<div class="dropdown">
							...
							<div class="content" id="profile_menu">
								<ul>
									<li>
										<a href="main.php?type=global&key=<?php echo $inf["user_key"]; ?>" class="menu-item">
									...
									<li>
										<a href="profile.php?type=local&key=<?php echo $inf["user_key"]; ?>" class="menu-item">
											<div class="icon-holder">
